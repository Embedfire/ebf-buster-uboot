cmd_u-boot-dtb.cfgout := arm-linux-gnueabihf-gcc -E -Wp,-MD,./.u-boot-dtb.cfgout.d  -nostdinc -isystem /opt/arm-gcc/bin/../lib/gcc/arm-linux-gnueabihf/4.9.3/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -fno-pic  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float    -pipe  -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a    -x c -o u-boot-dtb.cfgout board/freescale/mx6ullevk/imximage.cfg
